...
echo:                                                          
echo:          [1] Activate IDM                               
echo:          [2] Reset IDM activation/trial registry
echo:          _____________________________________________   
echo:                                                          
call :_color2 %_White% "          [3] switch Windows firewall  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                          
...
echo:       ___________________________________________________
echo:   
call :_color2 %_White% "        " %_Green% "on keyboard [1,2,3,4,5] Enter menu options in"
choice /C:12345 /N
set _erl=%errorlevel%
...
call :_color %Green% "IDM Activation - Successful reset in registry"
) else (
...
echo You can start from  https://www.internetdownloadmanager.com/download.html  download
goto done
)
...
echo:
call :_color %Gray% "If the piracy prompt appears, run the activation option again and it will not appear again."
goto done
)
...
If not defined name set name= Rnx
...
echo:
echo Triggering some downloads to create some registry keys, please wait...
...
echo The required registry keys were successfully created
) else (
